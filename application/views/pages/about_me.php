            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <p>Nama : dr.Arif Gunawan, Sp.PD</p>
                            <p>Emanil :</p>
                ...
                <div class="col-md-6">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <p>Nama : Anggun Lenteraningati</p>
                            <p>Emanil : anggunlentera.gmail.com</p>
                            <p>Riwayat Pendidikan :
                            <ul>
                                <li>SDN Kondang Jaya 3</li>
                                <li>SMPN 3 Karawang Barat</li>
                                <li>SMKN Pertanian Karawang</li>
                            </ul>
                            </p>
                        </div>
                    </div>
