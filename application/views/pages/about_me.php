<div class="container min-vh-100" style="margin-top: 8rem;">
    <div class="row">
        <div class="col-12 card bg-light border-0 mb-3 py-4">
            ...
            <div class="card-body">
                ...
                <p>Terdapat beberapa menu yang ada didalam website <span class="text-uppercase text-danger fw-bold">sipakar</span> yaitu :</p>
                <div class="row">
                    <div class="col-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="card bg-danger py-2 text-center shadow">
                    ...
                    <div class="col-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="card bg-secondary py-2 text-center shadow">
                            <div class="card-body">
