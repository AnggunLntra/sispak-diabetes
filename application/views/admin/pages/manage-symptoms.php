                        ...
                        <tbody>
                            <?php foreach ($gejala as $gjl) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $gjl['kode_gejala']; ?></td>
                                    <td><?php echo $gjl['gejala']; ?></td>
                                    <td class="text-center">
                                        <ul class="list-unstyled m-0">
                                            <li class="list-inline-item m-1">
                                                <a href="<?php echo base_url('Admin/Pages/Manage_Symptoms/Update_Symptoms/') . $gjl['kode_gejala'] ?>" class="btn btn-sm btn-secondary"><i class="fa fa-edit"></i></a>
                                            </li>
                                            <li class="list-inline-item m-1" onclick="javascript: return confirm('Hapus Data?')">
                                                <a href="<?php echo base_url('Admin/Pages/Manage_Symptoms/Delete_Symptoms/') . $gjl['kode_gejala'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
